 ...
 */
public class Question_Fragmants extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    public static Fragment getInstance(Context ct, FragmentManager fm) {
        ...
        mContext = ct;
        fragmentmanger = fm;
        fragment = new Question_Fragmants();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainPageActivity.setHeaderTitle(mContext,getResources().getString(R.string.question));
                    ...
                    public void onResponse(String response) {
                        ...
                        ques_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                Intent intent=new Intent(mContext, Answer_queActivity.class);
    ...
    //creating method for progress dialog
